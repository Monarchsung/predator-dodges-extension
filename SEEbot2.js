(function() {
    ...
    const directionalSectors = [
        { name: 'RIGHT', start: 337.5, end: 22.5, color: 'rgba(0, 255, 0, 0.2)' },
        { name: 'REAR_RIGHT', start: 22.5, end: 67.5, color: 'rgba(255, 165, 0, 0.2)' },
        { name: 'REAR', start: 67.5, end: 112.5, color: 'rgba(255, 0, 0, 0.2)' },
        { name: 'REAR_LEFT', start: 112.5, end: 157.5, color: 'rgba(255, 165, 0, 0.2)' },
        { name: 'LEFT', start: 157.5, end: 202.5, color: 'rgba(0, 255, 0, 0.2)' },
        { name: 'FRONT_LEFT', start: 202.5, end: 247.5, color: 'rgba(255, 165, 0, 0.2)' },
        { name: 'FRONT', start: 247.5, end: 292.5, color: 'rgba(255, 0, 0, 0.2)' },
        { name: 'FRONT_RIGHT', start: 292.5, end: 337.5, color: 'rgba(255, 165, 0, 0.2)' }
